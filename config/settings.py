...
# from .Settings_cnoc import * # import del nuevo modulo 
...
SECRET_KEY = 'django-insecure-p@+q1j23%3ogv6$h++ba(43ln1y9d5m()8pj&vq(56tt#a)=y*'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    #  BASE_DIR / 'static',          # opcional si ya existe
    BASE_DIR / 'app' / 'static' # agrega esta línea
]
